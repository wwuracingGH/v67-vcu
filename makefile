...
$(BINARY): blinky_test.o startup.o gpio.o can.o logging.o printf.o control.o system_stm32h5xx.o flash.o
...
.PHONY: reset
reset:
	openocd -f interface/stlink.cfg -f target/stm32h5x.cfg -c "reset"
