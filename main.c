...
//
////    FDCAN1->NBTP = ( << FDCAN_NBTP_NBRP_Pos)   |		// Bit rate prescaler. the actual value is one higher than programed (x+1)
////                   ( << FDCAN_NBTP_NTSEG1_Pos)|		// Nominal time segment before sample point  x+1
////                   ( << FDCAN_NBTP_NTSEG2_Pos);		// Nominal time segment after sample point x+1
//
